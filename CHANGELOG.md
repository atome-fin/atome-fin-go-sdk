...
Syncs the SDK to the upstream partner white-label `G` spec pinned as
`swagger-2026-09-21-429c4255.yaml`.

### Added

- **`bill.BillMainOrder.OrderType`** — echoes the originating capture
  order type, including TRANSPORT.
- **`transaction.TradePaymentInfo.OrderType`** and
  **`TradePaymentInfoDetail.OrderType`** — echoes the originating
  capture order type.
